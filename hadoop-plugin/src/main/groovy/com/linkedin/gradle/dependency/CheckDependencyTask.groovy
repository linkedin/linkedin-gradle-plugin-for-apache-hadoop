...
class CheckDependencyTask extends DefaultTask {
  ...
  void checkDependencies() {
    ...
    matchedDependencyPatterns.each {
      dependency, matchedPatterns ->
...
/**
 * Returns true if the dependency matches with dependencyPattern
 ...
 */
  ...
  /**
   * Creates and returns list of DependencyPatterns
   * @param project The gradle project
  ...
  String getDependencyPatternsJsonText(Project project) {
    ...
    if (Thread.currentThread().getContextClassLoader().getResource(dependencyPatternFile) != null) {
      ...
      throw new IOException("${dependencyPatternFile} was not found. ");
    }
