...
/**
 * Job class for type=WormholePushJob2 jobs. This job class is aimed at moving data from a HDFS path
 ...
 * </pre>
 */
class WormholePushJob2 extends HadoopJavaJob {
  // Required
  String inputPath;
  String namespace;
  String dataset;
  ...
  /**
   * Constructor for WormholePushJob2.
   *
   * @param jobName - The job name
   */
  WormholePushJob2(String jobName) {
    super(jobName);
    setJobProperty("type", "WormholePushJob2");
  }
   ...
   */
  @Override
  WormholePushJob2 clone() {
    return clone(new WormholePushJob2(name));
  }
   ...
   * @return The cloned job
   */
  WormholePushJob2 clone(WormholePushJob2 cloneJob) {
    ...
    return ((WormholePushJob2)super.clone(cloneJob));
  }
