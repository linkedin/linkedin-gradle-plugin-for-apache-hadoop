...
class LiHadoopShellCommandFactory {
  ...
  public LiHadoopShellCommand getCommand(LiBangBangJob job, Map<String, String> properties) {
    if (job instanceof LiPigBangBangJob) {
      return new LiPigCommand(properties);
    }
  }
}
